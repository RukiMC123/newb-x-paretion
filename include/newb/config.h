...
#define NL_EXPOSURE 1.8   // [toggle] 0.5 dark ~ 3.0 bright
#define NL_SATURATION 1.32 // [toggle] 0.0 grayscale ~ 4.0 super saturated
//#define NL_TINT vec3(1.0,0.75,0.5) // [toggle] color overlay

/* Terrain lighting */
#define NL_SUN_INTENSITY 4.99   // 0.5 weak ~ 5.0 bright
...
#define NL_MORNING_SUN_COL vec3(1.0,0.5,0.12)
#define NL_NOON_SUN_COL    vec3(1.0,0.6,0.3)
#define NL_NIGHT_SUN_COL vec3(0.1,0.1,0.2)
...
#define NL_DAY_ZENITH_COL    vec3(0.005,0.25,0.9)
...
#define NL_END_ZENITH_COL    vec3(0.06, 0.02, 0.11)
#define NL_END_HORIZON_COL   vec3(0.86, 0.32, 0.76)
#define NL_DAWN_ZENITH_COL   vec3(0.005,0.05,0.7)
#define NL_DAWN_HORIZON_COL  vec3(0.9,0.3,0.4)
#define NL_DAWN_EDGE_COL     vec3(0.94, 0.53, 0.35)
...
#define NL_WATER_TEX_OPACITY 2.5  // 0.0 plain water ~ 1.0 vanilla water texture
